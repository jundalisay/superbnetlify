...
The corpuscular theory, and even the principle of interference when applied only to direct rays and to rays reflected or inflected at the very edge of the opaque screen, cannot explain the phenomena of diffraction.

The proper theory is in the terms of waves, without recourse to any auxiliary hypothesis, by basing everything on the principle of Huygens and upon that of interference, both of which are inferences from the fundamental hypothesis.

Light consists in vibrations of the aether similar to sound-waves.
