...
It thus became possible to estimate the dissociation quantitatively, and to construct a general theory of electrolytes.

Contemporary physicists and chemists found it difficult at first to believe that a salt exists in dilute solution only in the form of ions, e.g. that the sodium and chlorine exist separately and independently in a solution of common salt. 

But there is a certain amount of chemical evidence in favour of Arrhenius' conception. For instance, the tests in chemical analysis are really tests for the ions; iron in the form of a ferrocyanide, and chlorine in the form of a chlorate, do not respond to the characteristic tests for iron and chlorine respectively, which are really the tests for the iron and chlorine ions.
